...
public class Newyeargiftbox 
{
    ...
    { 
        ...
        System.out.println("1.Kajju Barfi");
        System.out.println("2.Mothi Choor");
        System.out.println("3.Laddu");
        System.out.println("4.Kalakandh");
        ...
        case '1':
        	   ...
        	   weight=sc.nextInt();
        	   collect= new Kajjubarfi();
        	   total_weight=collect.calcwt( quantity, weight);
        	   totalbox_wt=totalbox_wt+total_weight;
        	   System.out.println("total weight of Kajjubarfi is:"+total_weight+"grams");
        ...
        case '2':
        	   ...
        	   System.out.println("please enter the weight in grams");
        	   weight=sc.nextInt();
        	   collect=new Mothichoor();
        	   total_weight=collect.calcwt(quantity, weight);
        	   totalbox_wt=totalbox_wt+total_weight;

        	   System.out.println("total weight of Mothi Choor is:"+total_weight+"grams");
        	   System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	   System.out.println("do you want any other item (y/n)");
        	   n1=sc.next().charAt(0);
        	      if(n1=='y'|| n1=='Y')
        ...
        case '3':
        	...
        	System.out.println("total weight of Laddu is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
        ...
        case '4':
        	...
        	System.out.println("please enter the weight in grams");
        	weight=sc.nextInt();
        	collect=new Kalakandh();
        	total_weight=collect.calcwt(quantity, weight);
        	totalbox_wt=totalbox_wt+total_weight;
        	total_candies=total_candies+quantity;

        	System.out.println("total weight of Kalakandh is:"+total_weight+"grams");
        	System.out.println("Total weight of gift box is:"+totalbox_wt+"grams");
        	System.out.println("do you want any other item (y/n)");
        	n1=sc.next().charAt(0);
        	if(n1=='y'|| n1=='Y')
